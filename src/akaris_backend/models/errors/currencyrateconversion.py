...
import dataclasses
from ..errors import conversionrate as errors_conversionrate
from ..errors import currencycode as errors_currencycode
...
class CurrencyRateConversion(Exception):
    ...
    target_currency: errors_currencycode.CurrencyCode = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TargetCurrency') }})
    r"""Currency codes are the three-letter alphabetic codes that represent the various currencies used throughout the world."""
