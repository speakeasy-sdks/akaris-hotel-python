...
class BuildFromCatalogOfferingHospitality:
    ...
    catalog_offering_identifier: Optional[Identifier] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CatalogOfferingIdentifier'), 'exclude': lambda f: f is None }})
