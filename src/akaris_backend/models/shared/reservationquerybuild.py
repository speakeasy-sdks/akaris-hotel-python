...
import dataclasses
from .reservationbuild import ReservationBuild
...
class ReservationQueryBuild:
    reservation_build: ReservationBuild = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ReservationBuild') }})
