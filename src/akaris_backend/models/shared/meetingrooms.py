...
class MeetingRooms:
    ...
    meeting_room: Optional[List[MeetingRoom]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MeetingRoom'), 'exclude': lambda f: f is None }})
