...
from ..shared import optinstatusenum as shared_optinstatusenum
from ..shared import yesnoinheritenum as shared_yesnoinheritenum
...
class Email:
    ...
    opt_in_status: Optional[shared_optinstatusenum.OptInStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('optInStatus'), 'exclude': lambda f: f is None }})
    ...
    opt_out_ind: Optional[shared_yesnoinheritenum.YesNoInheritEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('optOutInd'), 'exclude': lambda f: f is None }})
    ...
    share_marketing: Optional[shared_yesnoinheritenum.YesNoInheritEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shareMarketing'), 'exclude': lambda f: f is None }})
    r"""Used to indicate marketing preferences, Yes, No, Inherit"""
    share_sync: Optional[shared_yesnoinheritenum.YesNoInheritEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shareSync'), 'exclude': lambda f: f is None }})
    r"""Used to indicate marketing preferences, Yes, No, Inherit"""
