...
class ReservationResponse:
    ...
    reservation: Optional[ReservationID] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Reservation'), 'exclude': lambda f: f is None }})
