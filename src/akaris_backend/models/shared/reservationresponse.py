...
from ..shared import reservationid as shared_reservationid
...
class ReservationResponse:
    ...
    reservation: Optional[shared_reservationid.ReservationID] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Reservation'), 'exclude': lambda f: f is None }})
