...
import dataclasses
from ..shared import displaysequence as shared_displaysequence
...
class ReservationDisplaySequence:
    ...
    display_sequence: Optional[List[shared_displaysequence.DisplaySequence]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DisplaySequence'), 'exclude': lambda f: f is None }})
