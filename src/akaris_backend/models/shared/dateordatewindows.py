...
import dataclasses
from ..shared import durationunitenum as shared_durationunitenum
...
class DateOrDateWindows:
    ...
    duration_unit: Optional[shared_durationunitenum.DurationUnitEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('durationUnit'), 'exclude': lambda f: f is None }})
