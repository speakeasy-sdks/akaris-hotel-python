...
class FlightID:
    ...
    flight_ref: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FlightRef'), 'exclude': lambda f: f is None }})
    r"""Reference to a Flight object eslewhere in the message"""
