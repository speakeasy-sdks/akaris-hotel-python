...
import dataclasses
from .filedamount import FiledAmount
...
class NetRemitInfo:
    ...
    net_base_amount: Optional[FiledAmount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('NetBaseAmount'), 'exclude': lambda f: f is None }})
