...
from ..shared import dateordatewindows as shared_dateordatewindows
from ..shared import hotelsearchcriterion as shared_hotelsearchcriterion
from ..shared import searchcontrolconsolechannelid as shared_searchcontrolconsolechannelid
...
class CatalogOfferingsRequestHospitality:
    stay_dates: shared_dateordatewindows.DateOrDateWindows = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StayDates') }})
    ...
    hotel_search_criterion: Optional[shared_hotelsearchcriterion.HotelSearchCriterion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('HotelSearchCriterion'), 'exclude': lambda f: f is None }})
    maximum_amount: Optional[shared_currencyamount.CurrencyAmount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MaximumAmount'), 'exclude': lambda f: f is None }})
    ...
    minimum_amount: Optional[shared_currencyamount.CurrencyAmount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MinimumAmount'), 'exclude': lambda f: f is None }})
    r"""A monetary amount, up to 4 decimal places. Decimal place needs to be included."""
    ...
    search_control_console_channel_id: Optional[shared_searchcontrolconsolechannelid.SearchControlConsoleChannelID] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SearchControlConsoleChannelID'), 'exclude': lambda f: f is None }})
