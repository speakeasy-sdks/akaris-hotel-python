...
class ProductOptions:
    ...
    product_options_ref: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProductOptionsRef'), 'exclude': lambda f: f is None }})
